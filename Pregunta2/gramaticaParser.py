...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\2\2\2\'\2\t\3\2\2\2\4\21\3\2\2\2\6!\3\2\2\2\b\n\5\4\3")
        buf.write("\2\t\b\3\2\2\2\n\13\3\2\2\2\13\t\3\2\2\2\13\f\3\2\2\2")
        buf.write("\f\3\3\2\2\2\r\16\5\6\4\2\16\17\7\r\2\2\17\22\3\2\2\2")
        buf.write("\20\22\7\r\2\2\21\r\3\2\2\2\21\20\3\2\2\2\22\5\3\2\2\2")
        buf.write("\23\24\7\7\2\2\24\"\5\6\4\2\25\26\7\b\2\2\26\"\5\6\4\2")
        buf.write("\27\30\7\t\2\2\30\"\5\6\4\2\31\32\7\n\2\2\32\33\7\3\2")
        buf.write("\2\33\34\7\6\2\2\34\35\7\4\2\2\35\"\5\6\4\2\36\37\7\13")
        buf.write("\2\2\37\"\5\6\4\2 \"\7\5\2\2!\23\3\2\2\2!\25\3\2\2\2!")
        buf.write("\27\3\2\2\2!\31\3\2\2\2!\36\3\2\2\2! \3\2\2\2\"\7\3\2")
...
class gramaticaParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'('", "')'", "';'", "<INVALID>", "'encender'", 
                     "'apagar'", "'dibujar'", "'rotar'", "'mover'" ]

    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "NUMBER", "ENCENDER", "APAGAR", "DIBUJAR", "ROTAR", 
                      "MOVER", "WS", "NEWLINE" ]
    ...
    def prog(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << gramaticaParser.T__2) | (1 << gramaticaParser.ENCENDER) | (1 << gramaticaParser.APAGAR) | (1 << gramaticaParser.DIBUJAR) | (1 << gramaticaParser.ROTAR) | (1 << gramaticaParser.MOVER) | (1 << gramaticaParser.NEWLINE))) != 0)):
                    break
    ...
    def iniciar(self):
        ...
        try:
            ...
            if token in [gramaticaParser.T__2, gramaticaParser.ENCENDER, gramaticaParser.APAGAR, gramaticaParser.DIBUJAR, gramaticaParser.ROTAR, gramaticaParser.MOVER]:
    ...
    def stat(self):
        ...
        try:
            ...
            if token in [gramaticaParser.ENCENDER]:
                ...
                self.stat()
                pass
            elif token in [gramaticaParser.T__2]:
