...
class gramaticaListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by gramaticaParser#Rot.
    def enterRot(self, ctx:gramaticaParser.RotContext):
        pass

    # Exit a parse tree produced by gramaticaParser#Rot.
    def exitRot(self, ctx:gramaticaParser.RotContext):
        pass


    # Enter a parse tree produced by gramaticaParser#Rot2.
    def enterRot2(self, ctx:gramaticaParser.Rot2Context):
        pass

    # Exit a parse tree produced by gramaticaParser#Rot2.
    def exitRot2(self, ctx:gramaticaParser.Rot2Context):
        pass
    ...
    # Enter a parse tree produced by gramaticaParser#Rot3.
    def enterRot3(self, ctx:gramaticaParser.Rot3Context):
        pass

    # Exit a parse tree produced by gramaticaParser#Rot3.
    def exitRot3(self, ctx:gramaticaParser.Rot3Context):
        pass
